...
function StatusBar({
  ...
  const {
    ...
    Badge,
    IconButton
  } = window.dnhacksPlatformDesignSystem_c7577a;
  const {
    BatteryGauge,
    SignalGauge
  } = window.dnhacksPlatformDesignSystem_c7577a;
