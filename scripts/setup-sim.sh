#!/usr/bin/env bash
# ============================================================================
# Eye in the Sky -- Simulator Setup (Linux / WSL2 / macOS)
# ----------------------------------------------------------------------------
...
#   wsl -d Ubuntu -- bash -lc "cd /mnt/c/Users/User/Documents/eyeinthesky && bash scripts/setup-sim.sh"
#
...
echo
echo "============================================================"
echo " Eye in the Sky -- SITL environment ready!"
echo "============================================================"
echo
