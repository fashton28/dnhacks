# Eye in the Sky — Design System

A dark, high-density **mission-control design system** for *Eye in the Sky*, the
...
components from `window.EyeInTheSkyDesignSystem_c7577a`. The UI kit's `mock.js`
