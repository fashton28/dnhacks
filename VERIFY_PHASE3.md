...
Repo: `C:\Users\User\Documents\eyeinthesky\dnhacks` (Windows). You are verifying the
...
```powershell
cd C:\Users\User\Documents\eyeinthesky\dnhacks\ground\ui;          npm run typecheck; npm run lint; npm run build
cd C:\Users\User\Documents\eyeinthesky\dnhacks\ground\planner;     npm test
cd C:\Users\User\Documents\eyeinthesky\dnhacks\ground\satellite;   npm test
cd C:\Users\User\Documents\eyeinthesky\dnhacks\ground\app\windows; npm run typecheck
```
