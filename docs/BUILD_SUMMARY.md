...
`070c1b0` ("Build full Eye in the Sky drone system").
...
| **Windows NSIS installer** (`electron-builder --win nsis`) | **built** — `Eye in the Sky Setup 1.0.0.exe` (~79 MB) |
