#!/bin/sh
# Eye in the Sky GCS — .deb/.rpm post-install (LINUX_PRD §5).
...
cat > "$RULES_FILE" <<'EOF'
# Eye in the Sky — game-controller access for Manual Control (managed by package)
...
echo "Eye in the Sky: gamepad udev rule installed. Replug your controller if it is connected."
exit 0
